            ...
            <main className="flex-1">
                <div className="max-w-7xl mx-auto px-6 py-12">
                    <nav aria-label="Breadcrumb" className="mb-8 flex items-center gap-2 text-sm text-gray-500">
                        ...
                        <span>/</span>
                        <Link href="/engineering" className="hover:text-primary hover:underline underline-offset-4">Engineering</Link>
                        <span>/</span>
                        <span className="text-black">Semantic Car Search</span>
                    </nav>
                    <div className="grid lg:grid-cols-[250px_1fr] gap-12">
                        ...
                        <div className="space-y-20 max-w-4xl">
                            ...
                            <div className="flex flex-wrap items-center justify-between gap-4 border-t pt-8 text-sm">
                                <Link href="/engineering" className="font-medium hover:underline underline-offset-4">← Back to all engineering posts</Link>
                                <Link href="/" className="font-medium hover:underline underline-offset-4">Try the Wheeloh app →</Link>
                            </div>
