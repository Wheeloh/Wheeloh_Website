                ...
                <section className="pt-24 pb-16 px-6 max-w-7xl mx-auto">
                    ...
                    >
                        ...
                        <p className="text-xl md:text-2xl text-gray-600 max-w-3xl leading-relaxed">
                            Updates, research, and technical deep dives from the{" "}
                            <Link href="/" className="underline underline-offset-4 hover:text-black">Wheeloh</Link>{" "}
                            engineering team. Follow shipping updates on our{" "}
                            <Link href="/changelog" className="underline underline-offset-4 hover:text-black">changelog</Link>.
                        </p>
                    </motion.div>
