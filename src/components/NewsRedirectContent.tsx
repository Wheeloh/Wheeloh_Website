    ...
    if (newsId) {
      ...
      const redirectTimer = setTimeout(() => {
        ...
        if (/iPhone|iPad|iPod/i.test(userAgent)) {
          ...
          window.location.href = "https://apps.apple.com/fr/app/wheeloh-carspotting/id6746037128?utm_source=website&utm_medium=organic&utm_campaign=news_redirect";
        } else if (/android/i.test(userAgent)) {
          // Redirection vers Play Store
          window.location.href = "https://play.google.com/store/apps/details?id=com.wheeloh.app&utm_source=website&utm_medium=organic&utm_campaign=news_redirect&referrer=utm_source%3Dwebsite%26utm_medium%3Dorganic%26utm_campaign%3Dnews_redirect";
        } else {
